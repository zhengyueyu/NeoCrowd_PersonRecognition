...
void CentroidTracker::Init(cv::Mat frame, BaseDetector* detector, NetworkReid* reid)
{
    _detector = detector;
    frame_num = 0;
    this->reid = reid;
...
//vector<Ptr<Tracker>>::iterator CentroidTracker::DelTracker(vector<Ptr<Tracker>>::iterator it)
//{
//    vector<Ptr<Tracker>>::iterator newit;
//    for(int i = 0; i < multitracker.size(); i++)
//    {
//        if (it != (multitracker.begin() + i))
//            continue;
//        newit = multitracker.erase(it);
//        oldCentroid.erase(oldCentroid.begin() + i);
//    }
//    return newit;
//}
